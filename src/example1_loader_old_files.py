...
phenotypes, genotypes, genes, ph_ph_links, go_go_links, ph_gn_links, go_gn_links = load_data('../data_files/old_versions/hp.obo', '../data_files/old_versions/gene_ontology_edit.obo.2013-07-01', '../data_files/old_versions/ALL_SOURCES_ALL_FREQUENCIES_genes_to_phenotype.txt', '../data_files/old_versions/gene_association.goa_human.117')
...
#get_connected_phenotype_genotype_alternative_paths(phenotypes, genotypes, genes, ph_ph_links, go_go_links, ph_gn_links, go_gn_links, continuing=False)
